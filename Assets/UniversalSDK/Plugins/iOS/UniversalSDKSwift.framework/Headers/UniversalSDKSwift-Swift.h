...
#ifndef UNIVERSALSDKSWIFT_SWIFT_H
#define UNIVERSALSDKSWIFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UniversalSDKSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17UniversalSDKSwift14SDKLoginResult")
@interface SDKLoginResult : NSObject
...
SWIFT_CLASS("_TtC17UniversalSDKSwift18UniversalAPIClient")
@interface UniversalAPIClient : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) UniversalAPIClient * _Nonnull shared;)
